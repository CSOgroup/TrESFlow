...
- `assets/testdata/`
- `assets/test_realdata/samplesheet.real_multiome.yaml`
- `bin/run_stage_sc_process.py`
...
## Running the Multiome Test Profile
...
That stage directory contains:

- `mo_map.tsv`
- `sb_group_map.tsv`
- `pairs.tsv` with exact `dna_group_key -> rna_sample` mappings when grouped names match
- `stage_manifest.tsv`
- `sc_process_readiness.txt`
- grouped RNA `*.Solo.outGeneFull/` directories
- grouped RNA `*.filtered_cells.bam` files
