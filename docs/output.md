...
chromosomes resolved from the STAR index. The published BAM is normally
compressed; coverage and samtools QC consume the low-compression canonical
internal BAM.
